...
public class Texture{
	...
	public static Texture defWall = new Texture("stone.png", 64); //64x64 // so far only .png or .jpg work
    public static Texture mouradov = new Texture("mouradov64.jpg", 64);// make sure size is big enough for the image, else it wont work

    public static Texture door = new Texture("Door.png", 64);

    public static Texture puz5 = new Texture("rev3.png", 64);
//	@Override
